...
import uz.kmax.flagquiz.dialog.DialogAfrica
...
class AfricaFragment: BaseFragment<GameFragmentBinding>(GameFragmentBinding::inflate) {
    private val array by lazy { ArrayGame() }
    private val shared by lazy { SharedPref(requireContext()) }
    private var dialog = DialogAfrica()
