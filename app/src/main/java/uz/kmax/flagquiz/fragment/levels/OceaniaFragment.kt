...
import uz.kmax.flagquiz.dialog.DialogOceania
...
class OceaniaFragment : BaseFragment<GameFragmentBinding>(GameFragmentBinding::inflate) {
    private val array by lazy { ArrayGame() }
    private val shared by lazy { SharedPref(requireContext()) }
    private var dialog = DialogOceania()
