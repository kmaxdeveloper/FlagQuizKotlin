...
import uz.kmax.flagquiz.dialog.DialogEuropa
...
class EuropaFragment : BaseFragment<GameFragmentBinding>(GameFragmentBinding::inflate) {
    private val array by lazy { ArrayGame() }
    private val shared by lazy { SharedPref(requireContext()) }
    private val dialog = DialogEuropa()
