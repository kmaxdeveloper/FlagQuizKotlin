...
import uz.kmax.flagquiz.dialog.DialogAmericaS
...
class AmericaSFragment : BaseFragment<GameFragmentBinding>(GameFragmentBinding::inflate) {
    private val array by lazy { ArrayGame() }
    private val shared by lazy { SharedPref(requireContext()) }
    private var dialog = DialogAmericaS()
